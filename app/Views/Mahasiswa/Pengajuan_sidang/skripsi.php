...
<body>
    ...
    <div class="table-container">
        ...
        <?php if ($mahasiswa->i2 == '' && $proposal == null): ?>
            <center>
        ...
        <?php elseif ($mahasiswa->i2 != '' && $proposal == null): ?>
            <form action="<?php echo base_url('tambah/ajuskripsi') ?>" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <?php elseif ($mahasiswa->i2 != '' && $proposal != null): ?>
            <center>
                <h2>Anda Sudah Mengajukan Sidang Skripsi</h2>
            </center>
            <br><br>
            <div style="display: flex; justify-content: start; margin-bottom: 20px; align-items: center; gap: 40px;">
                <div style="display:flex; justify-content: start; gap: 33px; margin-bottom:20px; align-items: center;">
            ...
            <div style="display:flex; justify-content: start; gap: 20px; align-items: center;">
                ...
                <p>File Proposal:</p>
                <a href="<?php echo base_url('public/file_skripsi/') . $proposal->file ?>">
