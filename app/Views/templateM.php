...
<body>
    ...
    <div class="header">
        ...
        <div class="user-info">
            <button style="background-color: #0d5c52; margin-right: 20px; color: white; width: 80px; height: 25px;">Mahasiswa</button>
    ...
    <div class="container">
        ...
        <div class="left-box">
            ...
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                ...
                <a href="<?php echo base_url('dashboard/mahasiswa'); ?>" style="color: inherit; display: flex; text-decoration: none; align-items: center;">
            ...
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                ...
                <a href="<?php echo base_url('pedoman/mahasiswa') ?> " style="text-decoration: none; color: inherit;">
                    <p style="font-size: small; display: flex; align-items: center; padding-left: 10px;">Buku Pedoman</p>
                </a>
            </div>
            <br>

            <p style="font-size: small;">Bimbingan</p>
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                <img src="https://img.icons8.com/?size=100&id=38HJBFwphJ3I&format=png&color=FFFFFF" style="height: 20px; width: 20px; " alt="">
                <a href="<?php echo base_url('pembimbing/mahasiswa') ?> " style="text-decoration: none; color: inherit;">
            ...
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                ...
                <a href="<?php echo base_url('pengdul/mahasiswa') ?> " style="text-decoration: none; color: inherit;">
                    <p style="font-size: small; display: flex; align-items: center; padding-left: 10px;">Pengajuan Judul</p>
                </a>
            </div>
            <br>

            <p style="font-size: small;">Form Pengumpulan</p>
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                <img src="https://img.icons8.com/?size=100&id=b58dGpxAJV6v&format=png&color=FFFFFF" style="height: 20px; width: 20px; " alt="">
                <a href="<?php echo base_url('presensi/mahasiswa1') ?>" style="text-decoration: none; color: inherit;">
                    <p style="font-size: small; display: flex; align-items: center; padding-left: 10px;">Presensi Bimbingan I</p>
                </a>
            </div>
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                <img src="https://img.icons8.com/?size=100&id=b58dGpxAJV6v&format=png&color=FFFFFF" style="height: 20px; width: 20px; " alt="">
                <a href="<?php echo base_url('presensi/mahasiswa2') ?>" style="text-decoration: none; color: inherit;">
                    <p style="font-size: small; display: flex; align-items: center; padding-left: 10px;">Presensi Bimbingan 2</p>
                </a>
            </div>
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                <img src="https://img.icons8.com/?size=100&id=61852&format=png&color=FFFFFF" style="height: 20px; width: 20px; " alt="">
                <a href="<?php echo base_url('aju/proposal') ?>" style="text-decoration: none; color: inherit;">
                    <p style="font-size: small; display: flex; align-items: center; padding-left: 10px;">Pengajuan Proposal</p>
                </a>
            </div>
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                <img src="https://img.icons8.com/?size=100&id=61852&format=png&color=FFFFFF" style="height: 20px; width: 20px; " alt="">
                <a href="<?php echo base_url('aju/skripsi') ?>" style="text-decoration: none; color: inherit;">
                    <p style="font-size: small; display: flex; align-items: center; padding-left: 10px;">Pengajuan Skripsi</p>
                </a>
            </div>
            <br>
            ...
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                ...
                <a href="<?php echo base_url('profil/mahasiswa'); ?>" style="text-decoration: none; color: inherit; ">
    ...
    <div style="background-color: #cce7e7; text-align: center; height: 130px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
        ...
        <div style="display: flex; align-items: center; gap: 40px;">
            ...
            <a href="<?php echo base_url('jadwalM') ?>" style="text-decoration: none; color: inherit;">
                <p>Jadwal</p>
            </a>
            <a href="http://localhost/simbisa/welcome.html" style="text-decoration: none; color: inherit;">
                <p>About</p>
