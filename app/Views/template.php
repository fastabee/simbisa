...
<body>
    ...
    <div class="header">
        ...
        <div class="user-info">
            <button style="background-color: #0d5c52; margin-right: 20px; color: white; width: 70px; height: 25px;">Admin</button>
    ...
    <div class="container">
        ...
        <div class="left-box">
            ...
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                ...
                <a href="<?php echo base_url('dashboard') ?>" style="text-decoration: none; align-items:center; display: flex; color: inherit; ">
                    <p style="font-size: small; display: flex; align-items: center; padding-left: 10px;">Home</p>
                </a>
            </div>
            <br>

            <p style="font-size: small;">Buku Pedoman</p>
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                <img src="https://img.icons8.com/?size=100&id=42763&format=png&color=FFFFFF" style="height: 20px; width: 20px; " alt="">
                <a href="<?php echo base_url('pedoman') ?>" style="color: inherit; display:flex; align-items: center; text-decoration: none;">
                    <p style="font-size: small; display: flex; align-items: center; padding-left: 10px;">Buku Pedoman</p>
                </a>
            </div>
            <br>
            ...
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                ...
                <a href="<?php echo base_url('dosen/list') ?>" style="color: inherit; display:flex; align-items: center; text-decoration: none;">
                    <p style="font-size: small; display: flex; align-items: center; padding-left: 10px;">Informasi Dosen</p>
                </a>
            </div>
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                <img src="https://img.icons8.com/?size=100&id=38833&format=png&color=FFFFFF" style="height: 20px; width: 20px; " alt="">
                <a href="<?php echo base_url('mahasiswa/list') ?>" style="color: inherit; display:flex; align-items: center; text-decoration: none;">
                    <p style="font-size: small; display: flex; align-items: center; padding-left: 10px;">Informasi Mahasiswa</p>
                </a>
            </div>
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                <img src="https://img.icons8.com/?size=100&id=lUhlmU7d5ACn&format=png&color=FFFFFF" style="height: 20px; width: 20px; " alt="">
                <a href="<?php echo base_url('pembagian/list') ?>" style="color: inherit; display:flex; align-items: center; text-decoration: none;">
                    <p style="font-size: small; display: flex; align-items: center; padding-left: 10px;">Pembagian Pembimbing</p>
                </a>
            </div>
            <br>
            ...
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                ...
                <a href="<?php echo base_url('infoproposal') ?>" style="color: inherit; display:flex; align-items: center; text-decoration: none;">
                    <p style="font-size: small; display: flex; align-items: center; padding-left: 10px;">Informasi Proposal</p>
                </a>
            </div>
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                <img src="https://img.icons8.com/?size=100&id=62901&format=png&color=FFFFFF" style="height: 20px; width: 20px; " alt="">
                <a href="<?php echo base_url('infoskripsi') ?>" style="color: inherit; display:flex; align-items: center; text-decoration: none;">
                    <p style="font-size: small; display: flex; align-items: center; padding-left: 10px;">Informasi Skripsi</p>
                </a>
            </div>
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                <img src="https://img.icons8.com/?size=100&id=61852&format=png&color=FFFFFF" style="height: 20px; width: 20px; " alt="">
                <a href="<?php echo base_url('izinsidang') ?>" style="color: inherit; display:flex; align-items: center; text-decoration: none;">
                    <p style="font-size: small; display: flex; align-items: center; padding-left: 10px;">Persetujuan Sidang</p>
                </a>
            </div>
            <br>
            ...
            <div style="display: flex; justify-content: flex-start; padding-left: 25px; padding-top: 10px; ">
                ...
                <a href="<?php echo base_url('profil/admin') ?>" style="color: inherit; display:flex; align-items: center; text-decoration: none;">
    ...
    <div style="background-color: #cce7e7; text-align: center; height: 130px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
        ...
        <div style="display: flex; align-items: center; gap: 40px;">
            ...
            <a href="<?php echo base_url('jadwal') ?>" style="text-decoration: none; color: inherit;">
                <p>Jadwal</p>
            </a>
            <a href="http://localhost/simbisa/welcome.html" style="text-decoration: none; color: inherit;">
                <p>About</p>
