...
<div style="background-color: #cce7ec; height: 500px; padding-top: 20px; padding-left: 20px;">
    <form action="<?php echo base_url('update/mahasiswa/' . $data->userid) ?>" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <div style="display:flex; justify-content: start; gap: 90px; margin-bottom:20px; align-items: center;">
            ...
            <input type="text" name="jurusan" value="<?php echo $data2->jurusan ?>" style="border-radius: 5px; width: 300px; height: 40px;">
        </div>
