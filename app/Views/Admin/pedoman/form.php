...
<div style="background-color: #cce7ec; height: 390px; padding-top: 20px; padding-left: 20px;">
    <form action="<?php echo base_url('tambah/pedoman') ?>" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <div style="display:flex; justify-content: start; gap: 20px; align-items: center;">
            ...
            <label class="file-picker">
                ...
                <input type="file" name="filenya" accept="application/pdf" onchange="previewFile(this)">
